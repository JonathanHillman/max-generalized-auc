...
- Figure 5: Test AUM/AUC comparison across multiple seeds and datasets [[file:figure-test-aum-comparison.png][Top PNG]] (Test AUM Comparison)
[[file:figure-test-auc-comparison.png][Bottom PNG]] (Test AUC Comparison) [[file:figure-test-comparison.R][R code]]
